...
public class PointXYZUtils {
    ...
    public static double distanceXYZ(PointXYZ p1, PointXYZ p2) {
        ...
        double a = Math.sin(latDistance / 2) * Math.sin(latDistance / 2) + Math.cos(Math.toRadians(p1.getLatitude())) * Math.cos(Math.toRadians(p2.getLatitude())) * Math.sin(lonDistance / 2) * Math.sin(lonDistance / 2);
